...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri path2 =Uri.parse("android.resource://com.resbite.aestheticxd/"+R.raw.aestdh2);
        ...
        lottieSwitchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSwitchOn){
                    ...
                    ralativeLayout.setBackgroundResource(R.drawable.sak2);
                    ...
                    lottieSwitchButton.setMinAndMaxProgress(0.5f,1.0f);
                    lottieSwitchButton.playAnimation();
                    ralativeLayout.setBackgroundResource(R.drawable.sak3);
